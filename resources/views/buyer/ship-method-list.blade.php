...
@section('title', 'Ship Method List')
@section("content")
      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Ship Method List</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Ship Method List
					</li>
				  </ol>
				</div>
			  </div>
								...
								<div class="card-content collapse show">
									<div class="card-body card-dashboard">
										 ...
										 <table id="exported_data" class="table table-striped table-bordered">
											<thead>
											   <tr>
												<th>Ship Method Code</th>
												<th>Ship Method Description</th>
												<th>Notes</th>
											...
											<tbody>
												...
												@if(count($ship_method_list) > 0)
													@foreach($ship_method_list as $eachitem)
													<tr>
														<td>{{$eachitem['name']}}</td>
														<td>{{$eachitem['description']}}</td>
														<td>{{$eachitem['notes']}}</td>
														<td> <a href="{{url('/buyer/edit-ship-method')}}/{{$eachitem['id']}}">Edit</a> | <a  onclick="deleteFunccom('ShipMethod',{{$eachitem['id']}})" href="javascript:void(0)">Delete</a></td>
													</tr>
													@endforeach
												@endif
