...
@section('title', 'Product Group List')
@section("content")
      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Product Group List</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Product Group List
					</li>
				  </ol>
				</div>
			  </div>
									 ...
									 <table id="exported_data" class="table table-striped table-bordered">
											...
											<tbody>
												...
												@if(count($product_group_list) > 0)
													@foreach($product_group_list as $eachitem)
													<tr>
														<td>{{$eachitem['group_code']}}</td>
														<td>{{$eachitem['description']}}</td>
														<td>{{$eachitem['notes']}}</td>
														<td> <a href="{{url('/buyer/edit-product-group')}}/{{$eachitem['id']}}">Edit</a> | <a  onclick="deleteFunccom('ProductGroup',{{$eachitem['id']}})" href="javascript:void(0)">Delete</a></td>
													</tr>
													@endforeach
												@endif
