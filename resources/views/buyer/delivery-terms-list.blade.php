...
@section('title', 'Delivery Terms List')
@section("content")
      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Delivery Terms List</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Delivery Terms List
					</li>
				  </ol>
				</div>
			  </div>
								...
								<div class="card-content collapse show">
									<div class="card-body card-dashboard">
										 ...
										 <table id="exported_data" class="table table-striped table-bordered">
											...
											<tbody>
												@if(count($delivery_term_list) > 0)
													@foreach($delivery_term_list as $eachitem)
														<tr>
															<td>{{$eachitem['termcode']}}</td>
															<td>{{$eachitem['description']}}</td>
															<td>{{$eachitem['notes']}}</td>
															<td><a href="{{url('/buyer/edit-delivery-terms')}}/{{$eachitem['id']}}">Edit</a> | <a onclick="deleteFunccom('DeliveryTerm',{{$eachitem['id']}})" href="javascript:void(0)" href="#">Delete</a></td>
														</tr>
													@endforeach
												@endif
