...
@section('title', 'Ship Location List')
@section("content")
      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Ship Location List</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Ship Location List
					</li>
				  </ol>
				</div>
			  </div>
									...
									<div class="table-responsive">
										 <table id="exported_data" class="table table-striped table-bordered">
											...
											<tbody>
												 ...
												 @if(count($ship_location_list) > 0)
													@foreach($ship_location_list as $eachitem)
												<?php
										...
										?>
													<tr>
														...
														<td>{{$eachitem['contactname']}}</td>
														<td>{{$eachitem['st_address']}}</td>
														<td>{{$eachitem['city']}}</td>
														<td>{{$statename}}</td>
														<td>{{$eachitem['zipcode']}}</td>
														<td>{{$countryname}}</td>
														<td><a href="{{url('/buyer/ship-details')}}/{{$eachitem['id']}}">Detail</a> | <a href="{{url('/buyer/edit-ship-location')}}/{{$eachitem['id']}}">Edit</a> | <a  onclick="deleteFunccom('ShipLocation',{{$eachitem['id']}})" href="javascript:void(0)">Delete</a></td>
													</tr>
													@endforeach
												@endif
