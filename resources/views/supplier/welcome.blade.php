            ...
            <div class="card border-grey Welcome_box border-lighten-3 m-0">
                ...
                <div class="card-content">
                    <div class="card-body">
						...
						@endif
						<form class="form-horizontal form-simple" method="POST" action="{{ url('/supplier/templogin') }}" novalidate>
							 @csrf
							<div class="form-horizontal form-simple" novalidate>
							   <div class="">
								<fieldset class="form-group position-relative has-icon-left mb-0">
									<input name="email" value="{{$username}}" type="email" class="form-control form-control-lg input-lg" id="user-name" placeholder="Email Address" required>
