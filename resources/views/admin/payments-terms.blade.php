      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Payment Terms</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Payment Terms
					</li>
				  </ol>
				</div>
			  </div>
								...
								<div class="card-content collapse show">
									...
									<table id="exported_data" class="table table-striped table-bordered">
												...
												<tr>
													...
													<td>
														...
														<div style="display:none;" id="text_field_div_{{$eachitem['id']}}">
															...
															<input value="Save" type="button" class="save_btn btn btn-info" onclick="updateByID('PaymentTerms',{{$eachitem['id']}})">
														</div>
													</td>
													...
													<td><a onclick="editFunc({{$eachitem['id']}})" href="javascript:void(0)">Edit</a> | <a  onclick="deleteFunc('PaymentTerms',{{$eachitem['id']}})" href="javascript:void(0)">Delete</a></td>
												</tr>
													@endforeach
												@endif
									   ...
									   {{-- error --}}
										...
										@endif
										<br>
										<form id="PYForm" class="form" method="POST" action="{{ url('admin/submitPaymentApi') }}" novalidate>
											@csrf
										@csrf
											<div class="form-body input_fields_wrap">
												<div class="row">
													   <div class="col-md-8 col-sm-12 col-12 mb-2">
														   <div><input type="text" class="form-control required" placeholder="Add new Payment Term" name="name[1]"  ></div>
													   </div>
   ...
   $(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row main"><div class="col-md-8 col-sm-12 col-12 mb-2"><input type="text" class="form-control required" placeholder="Add new Payment Term" name="name['+x+']" /></div> <div class="col-md-4 col-sm-12 col-12 mb-2"><a href="#" class="remove_field">Remove</a></div></div>'); //add input box
