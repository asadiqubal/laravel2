      ...
      <div class="content-wrapper">
        <div class="content-header row">
			  <div class="content-header-left col-md-6 col-12 mb-1">
				<h3 class="content-header-title">Add Company users</h3>
			  </div>
			  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
				<div class="breadcrumb-wrapper col-12">
				  ...
				  <li class="breadcrumb-item"><a href="{{url('/admin/dashboard')}}">Home</a>
					...
					<li class="breadcrumb-item active">Add Company users
					</li>
				  </ol>
				</div>
			  </div>
												...
												<div class="row">
													...
													<div class="col-12">
														<div class="form-group">
															...
															<input type="text" id="projectinput4" class="form-control" name="name">
														</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="col-12">
														<div class="form-group">
															...
															<input type="text" id="projectinput6" class="form-control" name="phone">
														</div>
													</div>
													<div class="col-12">
														<div class="form-group">
															<label for="projectinput7">Email</label>
															<input type="email" id="projectinput7" class="form-control" name="email">
														</div>
													</div>
												</div>
											</div>
