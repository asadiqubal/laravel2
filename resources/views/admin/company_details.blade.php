    ...
    <div class="app-content content">
      <div class="content-wrapper">
        ...
        <div class="content-body"><!-- Sales stats -->
		    ...
		    <div class="row">
               <h4>Company Name : </h4>&nbsp;  {{$companydetails[0]['name']}} <br>
            </div>
            <div class="row">
               <h4>Address : </h4>&nbsp;  {{$companydetails[0]['address']}} <br>
               </div>
           
            <div class="row">
               <h4>Industry : </h4>&nbsp; {{$companydetails[0]['industry_name']}} <br>
               </div>
            <div class="row">
               <h4>RFQ Range : </h4> &nbsp;{{$companydetails[0]['sequence_letter']}} {{$companydetails[0]['start_from']}} - {{$companydetails[0]['sequence_letter']}} {{$companydetails[0]['end_to']}}
</div>
