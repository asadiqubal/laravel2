...
Route::group(['prefix' => 'buyer'], function() {
	...
	Route::get('/getPaymentStatus/{id}', 'BuyerController@getPaymentStatus')->name('getPaymentStatus');
	...
	Route::get('/status-change-quote/{rfq_id}/{supplier_id}/{status}', 'BuyerController@statusChangeofQuote')->name('status-change-quote');
