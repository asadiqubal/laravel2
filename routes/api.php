...
Route::namespace('Api')->group(function () {
    ...
    Route::namespace('V1')->prefix('/v1')->group(function () {
        ...
        Route::get('getrfqStatusList', 'AdminDashboardController@getrfqStatusList');
        ...
        */
		...
		Route::get('draftRfqList/{id}', 'BuyerDashboardController@draftRfqList');
		...
		Route::get('rfqItemSendDetailForSupplierPanel/{id}/{rfqid}', 'BuyerDashboardController@rfqItemSendDetailForSupplierPanel');
